...
// Using spread and destructuring assignment, create a new array called newPeople', which is a copy of the people` array, with a person named ‘Odie’ added to the beginning and one named ‘Yuki’ added to the end.
...
// Using the array of people given
const people = ['Kookla','Fran','Ollie'];

let newPeople = ['Matto', ...people, 'Yuki'];
...
let newStuff = {...stuff};
newStuff.cars = [...newStuff.cars, 'Nissan Z'];

let state = {...[people], ...stuff};
state.people

let newState = {...[['Matto', ...people, 'Yuki']], ...{...stuff}};
newState.cars = [...newState.cars, 'Nissan Z'];
