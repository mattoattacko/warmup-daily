...
filter = (array) => {
  let filter = array.filter(number => number < 8);
...
// Who hates short shorts? Nobody hates short shorts
...
let newStuff = {...stuff};
newStuff.cars = [...newStuff.cars, 'Ferrari 308'];
let state = {...[people], ...stuff};
state.people
let newState = {...[['Odie', ...people, 'Garefield']], ...{...stuff}};
newState.cars = [...newState.cars, 'Ferrari 308'];
